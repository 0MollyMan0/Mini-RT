...
/*   Updated: 2026/07/08 14:41:50 by anfouger         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_key_pressed(int keycode, t_data *data)
{
	if (keycode == 65307)
		...
		rotate_camera_yaw(&data->scene.cam, -ROT_SPEED * M_PI / 180.0);
	else if (keycode == KEY_LEFT)
		rotate_camera_yaw(&data->scene.cam, ROT_SPEED * M_PI / 180.0);
	else if (keycode == KEY_UP)
		rotate_camera_pitch(&data->scene.cam, ROT_SPEED * M_PI / 180.0);
